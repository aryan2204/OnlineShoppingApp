...
namespace OnlineShopping.Models
{
    ...
    public partial class Online_ShoppingEntities : DbContext
    {
        ...
        public virtual int InsertProdDetails(string id, string name, Nullable<int> quan, Nullable<double> price, string prodDescription, string pic, string col, string size, Nullable<int> retID, string category, string brand)
        {
            var idParameter = id != null ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(string));
        ...
        public virtual int InsertProductDetails(string id, string name, Nullable<int> quan, Nullable<double> price, string prodDescription, string brand, string size, string col, string pic)
        {
            var idParameter = id != null ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(string));
        ...
        public virtual ObjectResult<string> LoginRetailer1(string email)
        {
            var emailParameter = email != null ?
                new ObjectParameter("email", email) :
                new ObjectParameter("email", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("LoginRetailer1", emailParameter);
        }
    
        public virtual ObjectResult<PaymentDetail_Result> PaymentDetail()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<PaymentDetail_Result>("PaymentDetail");
        }
        ...
        public virtual int UpdateProductDetails(string id, string name, Nullable<int> quan, Nullable<double> price, string prodDescription, string brand, string size, string col, string pic)
        {
            var idParameter = id != null ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(string));
