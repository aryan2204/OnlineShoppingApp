...
namespace OnlineShopping.Controllers
{
    ...
    public class ProductDetailsController : ApiController
    {
        ...
        {
            db.InsertProductDetails1(productDetail.Product_Id, productDetail.Product_Name, productDetail.Quantity, productDetail.Unit_Price,
